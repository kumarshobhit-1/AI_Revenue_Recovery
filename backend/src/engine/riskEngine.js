...
export const FAILURE_WEIGHTS = {
  ...
  CHECKOUT_ABANDONED_SESSION: 0.80,
  RECURRING_MANDATE_DECLINED: 0.75,
  SUBSCRIPTION_RENEWAL_FAIL: 0.75,
  OVERDUE_INVOICE_30D: 0.70,
  UNPAID_INVOICE_60D: 0.50,
  PAYMENT_DEGRADATION_WARNING: 0.85,
  PROMISE_TO_PAY_PENDING: 0.90,
  STOLEN_CARD: 0.0,
  INVALID_ACCOUNT: 0.0,
  ACCOUNT_CLOSED: 0.0,
